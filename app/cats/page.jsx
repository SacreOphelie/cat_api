...
export default function CatsPage() {
  ...
  useEffect(() => {
    fetch("https://api.thecatapi.com/v1/images/search?limit=1", {
      headers: {
        "x-api-key": "live_ns4N1WONcO5A51z7TvNWoEgYB42FvidHGNUBHR0CEMKcahp8F41H1ckEsywJcFNI"
      }
    })
      .then(res => res.json())
      ...
      {cat && (
        <div className="w-100 h-100 rounded-2xl !p-4 bg-fuchsia-800">
            ...
            <div className=" flex items-center justify-between !p-2">
                ...
                <svg id="Next" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 155.21 307.47" className="w-10 h-8 cursor-pointer text-white hover:text-pink-200 hover:scale-110">
                    <g>
