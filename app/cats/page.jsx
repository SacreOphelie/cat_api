...
export default function CatsPage() {
  ...
  const notifFav = () => toast("Meow ! I'm in your favorites now !")
    ...
    <div className="w-screen h-screen flex items-center justify-center">
      <div className="w-100 h-125 rounded-2xl !p-5 bg-fuchsia-800 flex flex-col items-center justify-center gap-5">
        ...
        <div className=" flex items-center justify-between !p-2 w-full">
            {/* Mettre en favoris */}
            <svg className="w-10 h-8 cursor-pointer text-white hover:text-pink-200 hover:scale-110" version="1.0" id="heart" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" onClick={notifFav} >
                <g>
                    {/* le currentColor va prendre la couleur du texte parent => permettra au hover de fonctionner */}
                    <path fill="currentColor" d="M48,6c-4.418,0-8.418,1.791-11.313,4.687l-3.979,3.961c-0.391,0.391-1.023,0.391-1.414,0
                    c0,0-3.971-3.97-3.979-3.961C24.418,7.791,20.418,6,16,6C7.163,6,0,13.163,0,22c0,3.338,1.024,6.436,2.773,9
